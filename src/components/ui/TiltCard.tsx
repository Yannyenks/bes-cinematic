...
export function TiltCard({
  ...
  return (
    ...
    >
      <div
        ref={panelRef}
        className="group/tilt relative overflow-hidden rounded-3xl border border-white/12 bg-white/[0.05] p-8 shadow-[0_30px_60px_-30px_rgba(0,0,0,0.8)] transition-transform duration-300 ease-out will-change-transform"
        style={{
          transform:
